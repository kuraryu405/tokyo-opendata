...
const copy = {
  ja: {
    ...
    safeguards: "アカウント、恒久ユーザーID、Cookieによる訪問横断追跡、学習・二次利用は行いません。",
  ...
  en: {
    ...
    retention: "Retention: only content that passes masking or rejection is kept indefinitely. The previous automatic-expiry condition no longer applies.",
    ...
    safeguards: "No account, permanent user ID, cross-visit cookie tracking, training, or secondary use.",
  ...
  my: {
    ...
    retention: "သိမ်းဆည်းကာလ: ဖုံးကွယ်ခြင်း သို့မဟုတ် ငြင်းပယ်ခြင်းကို ကျော်ဖြတ်သောအရာများကို ကာလမသတ်မှတ်ဘဲ သိမ်းမည်။ ယခင် အလိုအလျောက်သက်တမ်းကုန်စည်းမျဉ်း မသုံးတော့ပါ။",
