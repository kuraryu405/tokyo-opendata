...
const copy = {
  ja: {
    ...
    conversationAccepted: "会話保存に同意しています。今後のAI応答は、送信前に削除情報をこのタブへ保持できた場合だけ保存します。",
  ...
  en: {
    ...
    conversationAccepted: "Conversation storage is enabled. Future AI responses are saved only after deletion information is recoverable in this tab before sending.",
  ...
  my: {
    ...
    conversationAccepted: "စကားပြောသိမ်းဆည်းမှုကို သဘောတူထားပါသည်။ မပို့မီ ဖျက်ရန်အချက်အလက်ကို ဤ tab တွင် ပြန်လည်ရယူနိုင်မှသာ နောက်လာမည့် AI အဖြေများကို သိမ်းပါမည်။",
