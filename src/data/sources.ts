...
/** A deliberately small registry of every source shown by the MVP. */
...
export const sourceRegistry: Record<string, DataSource> = {
  ...
  KITA_ELEMENTARY_SCHOOLS_OPEN_DATA: {
    id: "KITA_ELEMENTARY_SCHOOLS_OPEN_DATA",
    title: "区立小学校一覧",
    publisher: "東京都北区",
    url: kitaOpenDataPageUrl,
    downloadUrl: "https://www.city.kita.lg.jp/_res/projects/default_project/_page_/001/014/461/syougakkou-2.csv",
    sourceType: "open_data",
    category: "elementary schools",
    fetchedAt: kitaLocalResourcesCache.fetchedAt,
    license: kitaLicense,
    licenseUrl: kitaLicenseUrl,
  ...
  KITA_MEDICAL_INSTITUTIONS_OPEN_DATA: {
    id: "KITA_MEDICAL_INSTITUTIONS_OPEN_DATA",
    title: "自治体標準オープンデータセット：医療機関一覧",
    publisher: "東京都北区",
    url: kitaOpenDataPageUrl,
    downloadUrl: "https://www.city.kita.lg.jp/_res/projects/default_project/_page_/001/014/461/hyo-jyun.zip",
    sourceType: "open_data",
  ...
  KITA_CHILDCARE_FACILITIES_OPEN_DATA: {
    id: "KITA_CHILDCARE_FACILITIES_OPEN_DATA",
    title: "自治体標準オープンデータセット：子育て施設一覧",
    publisher: "東京都北区",
    url: kitaOpenDataPageUrl,
    downloadUrl: "https://www.city.kita.lg.jp/_res/projects/default_project/_page_/001/014/461/hyo-jyun.zip",
    sourceType: "open_data",
  ...
  KITA_PUBLIC_FACILITIES_OPEN_DATA: {
    id: "KITA_PUBLIC_FACILITIES_OPEN_DATA",
    title: "自治体標準オープンデータセット：公共施設一覧",
    publisher: "東京都北区",
    url: kitaOpenDataPageUrl,
    downloadUrl: "https://www.city.kita.lg.jp/_res/projects/default_project/_page_/001/014/461/hyo-jyun.zip",
    sourceType: "open_data",
  ...
  TOKYO_CONSULTATION: {
    ...
    fetchedAt: officialInformationCheckedAt,
