...
const resourceCounts = localResources.reduce<Partial<Record<LocalResourceCategory, number>>>((counts, resource) => {
...
export const kitaMyanmarProfile: MunicipalityCrisisProfile = {
  ...
  coverageNotes: [
    ...
    "Resource counts are derived from the curated, source-backed Open Data cache used by this MVP, not citywide capacity or a complete facility count.",
