...
export const viMessages = {
  ...
  ui: {
    ...
    why: "Vì sao tôi thấy hướng dẫn này?", source: "Nguồn tham khảo", verified: "Đã xác minh", human: "Cần được xem xét từng trường hợp", localTitle: "Những nơi cần kiểm tra trong khu vực này",
  ...
  questions: [
    ...
    ["Hiện bạn đang lo lắng về điều gì?", "Chọn tất cả mục phù hợp.", [["stay", "Tôi có thể ở lại bao lâu"], ["consultation", "Nơi để hỏi hỗ trợ"], ["accommodation", "Chỗ ở"], ["living_cost", "Chi phí sinh hoạt"], ["employment", "Việc làm"], ["education", "Trường học và giáo dục"], ["childcare", "Cuộc sống hằng ngày của con tôi"], ["medical", "Chăm sóc y tế"], ["language", "Tiếng Nhật"]]],
...
export const thMessages = {
  ...
  ui: {
    ...
    why: "ทำไมฉันจึงเห็นคำแนะนำนี้?", source: "แหล่งข้อมูลอ้างอิง", verified: "ตรวจสอบแล้ว", human: "ต้องพิจารณาเป็นรายบุคคล", localTitle: "สถานที่ที่ควรตรวจสอบในพื้นที่นี้",
  ...
  questions: [
    ...
    ["ขณะนี้คุณกังวลเรื่องใด?", "เลือกได้ทุกข้อที่ตรงกับคุณ.", [["stay", "ฉันจะอยู่ได้อีกนานเท่าใด"], ["consultation", "จะขอความช่วยเหลือได้ที่ไหน"], ["accommodation", "ที่พัก"], ["living_cost", "ค่าใช้จ่ายในการดำรงชีวิต"], ["employment", "งาน"], ["education", "โรงเรียนและการศึกษา"], ["childcare", "ชีวิตประจำวันของลูก"], ["medical", "การรักษาพยาบาล"], ["language", "ภาษาญี่ปุ่น"]]],
