...
export const zhCNMessages = {
  ...
  ui: {
    ...
    why: "为什么会看到这项建议？", source: "依据来源", fetched: "获取日期", changesMade: "已从北区 Open Data 中选取部分数据并为 StayBridge 进行了规范化。", human: "需要个别确认", localTitle: "本地区可联系或确认的地点",
...
export const zhTWMessages = {
  ...
  ui: {
    ...
    why: "為什麼會看到這項建議？", source: "依據來源", fetched: "取得日期", changesMade: "已從北區 Open Data 中選取部分資料並為 StayBridge 進行正規化。", human: "需要個別確認", localTitle: "本地區可聯絡或確認的地點",
...
export const koMessages = {
  ...
  ui: {
    ...
    why: "이 안내가 표시되는 이유", source: "근거 자료", fetched: "가져온 날짜", changesMade: "Kita City Open Data 중 일부를 선택해 StayBridge용으로 정규화했습니다.", human: "개별 확인 필요", localTitle: "이 지역에서 확인할 곳",
