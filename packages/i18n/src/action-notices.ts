...
export const actionNotices = {
  ja: {
    ...
    CHECK_CHILD_EDUCATION_GUIDANCE: "確認先: 東京都・教育委員会・文科省等の公式案内または自治体の教育窓口。確認項目: 就学手続き、相談先。",
    FIND_NEARBY_SCHOOLS: "確認先: 自治体のオープンデータで公開されている小学校。確認項目: 住所、連絡先。注意: 就学可否・学区・空き・日本語支援・受入可否は保証しません。",
  ...
  en: {
    ...
    CHECK_CHILD_EDUCATION_GUIDANCE: "Where to confirm: official guidance from TMG, the Board of Education, or MEXT, or the municipality education desk. What to ask: enrollment procedures and consultation desks.",
    FIND_NEARBY_SCHOOLS: "Where to confirm: elementary schools published as open data for the municipality. What to ask: address and contact. Note: does not guarantee admission, catchment, vacancy, language support, or acceptance.",
  ...
  my: {
    ...
    CHECK_CHILD_EDUCATION_GUIDANCE: "အတည်ပြုရန်နေရာ: TMG၊ ပညာရေးဘုတ်အဖွဲ့ သို့မဟုတ် MEXT ၏ တရားဝင်လမ်းညွှန် သို့မဟုတ် မြို့နယ်ပညာရေးဌာန။ မေးရန်: ကျောင်းဝင်ခွင့်လုပ်ထုံးလုပ်နည်းနှင့် တိုင်ပင်ရာဌာန။",
    FIND_NEARBY_SCHOOLS: "အတည်ပြုရန်နေရာ: မြို့နယ်အတွက် 공개ဒေတာအဖြစ် ထုတ်ပြန်ထားသော မူလတန်းကျောင်း။ မေးရန်: လိပ်စာနှင့် ဆက်သွယ်ရန်။ သတိ: ကျောင်းဝင်ခွင့်၊ နယ်မြေ၊ လစ်လပ်မှု၊ ဘာသာစကားအကူအညီ သို့မဟုတ် လက်ခံမှုကို အာမမခံပါ။",
