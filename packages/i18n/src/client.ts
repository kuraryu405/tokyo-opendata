...
export type PublicUserMessages = UserMessages & {
  ...
  otherAnswers: Record<"area" | "nationality" | "visitPurpose" | "family" | "accommodation" | "needs", {
    label: string;
    placeholder: string;
    required: string;
    notice: string;
...
const jaMessagesWithoutDailyLife = {
  ...
  questions: [
    ["東京のどの地域に滞在していますか？", "", [["Kita", "北区"], ["Shinjuku", "新宿区"], ["Toshima", "豊島区"], ["Other", "その他"]]],
    ["国籍・地域を教えてください。", "", [["MMR", "ミャンマー"], ["OTHER", "その他"], ["UNKNOWN", "答えたくない"]]],
    ["日本にはどのような予定で来ましたか？", "", [["tourism", "旅行"], ["visiting_family_or_friends", "家族・知人を訪ねるため"], ["work", "仕事"], ["study", "留学"], ["resident", "日本に住んでいる"], ["other", "その他"], ["unknown", "分からない / 答えたくない"]]],
    ["日本をいつ出る予定でしたか？", "", [["within_7_days", "7日以内"], ["within_30_days", "30日以内"], ["within_3_months", "3か月以内"], ["no_departure_plan", "帰国予定はなかった"], ["unknown", "分からない"]]],
    ["予定どおり帰国できますか？", "", [["possible", "帰国できる"], ["difficult", "帰国することが難しい"], ["unknown", "分からない"]]],
    ["日本にいつまで滞在できるか分かりますか？", "", [["known", "分かっている"], ["unknown", "分からない"], ["documents", "書類を確認したい"]]],
    ["一緒に日本にいる家族はいますか？", "", [["none", "いない"], ["children", "子どもがいる"], ["spouse", "配偶者がいる"], ["other", "その他家族がいる"]]],
    ["どこに滞在していますか？", "", [["hotel", "ホテル・宿泊施設"], ["family_or_friend", "家族・知人の家"], ["rental", "賃貸住宅"], ["temporary_facility", "一時的な施設"], ["unstable", "今後の滞在場所に不安がある"], ["prefer_not_to_say", "答えたくない"]]],
    ["現在困っていることは何ですか？", "複数回答可", [["stay", "日本にいつまでいられるか"], ["consultation", "相談先"], ["accommodation", "今後の住む場所"], ["living_cost", "生活費"], ["employment", "仕事"], ["education", "子どもの学校・教育"], ["childcare", "子どもの生活"], ["medical", "医療"], ["language", "日本語"], ["none", "特になし"]]],
    ["日本語をどのくらい話せますか？", "", [["none", "ほとんど話せない"], ["beginner", "少し話せる"], ["daily", "日常会話ができる"], ["advanced", "十分話せる"]]],
  ],
  otherAnswers: {
    ...
    accommodation: { label: "その他の滞在場所を入力", placeholder: "例：友人が手配した場所", required: "「その他」を選んだ場合は入力が必要です。", notice: "正確な住所や施設名は入力しないでください。この内容は Workers AI には送信されません。" },
    needs: { label: "その他の困りごとを入力", placeholder: "例：生活に必要な手続", required: "「その他」を選んだ場合は入力が必要です。", notice: "困っている内容を短く入力してください。この内容は Workers AI には送信されません。" },
  },
  actions: {
  ...
  needs: { stay: "日本にこれからどのくらい滞在できるか", consultation: "必要な手続と相談先", accommodation: "当面の宿泊・生活", living_cost: "生活費についての相談", employment: "働ける条件", education: "子どもの教育", childcare: "子どもの生活", medical: "医療を受けられる場所", language: "言語サポート", daily_life: "日々の生活", other: "その他", none: "特になし" },
...
const enMessagesWithoutDailyLife = {
  ...
  otherAnswers: {
    ...
    accommodation: { label: "Enter your other place to stay", placeholder: "Example: a place arranged by a friend", required: "Enter a value when Other is selected.", notice: "Do not enter an exact address or facility name. This text is not sent to Workers AI." },
    needs: { label: "Enter your other concern", placeholder: "Example: a daily-life procedure", required: "Enter a value when Other is selected.", notice: "Briefly describe the concern. This text is not sent to Workers AI." },
  },
  ui: {
...
const myMessagesWithoutDailyLife = {
  ...
  otherAnswers: {
    ...
    accommodation: { label: "အခြားနေထိုင်ရာကို ရေးပါ", placeholder: "ဥပမာ - မိတ်ဆွေ စီစဉ်ပေးသော နေရာ", required: "အခြားကို ရွေးထားပါက ဤအကွက်ကို ဖြည့်ရန် လိုအပ်ပါသည်။", notice: "လိပ်စာအတိအကျ သို့မဟုတ် နေရာအမည် မရေးပါနှင့်။ ဤစာကို Workers AI သို့ မပို့ပါ။" },
    needs: { label: "အခြားစိုးရိမ်ချက်ကို ရေးပါ", placeholder: "ဥပမာ - နေ့စဉ်ဘဝအတွက် လုပ်ထုံးလုပ်နည်း", required: "အခြားကို ရွေးထားပါက ဤအကွက်ကို ဖြည့်ရန် လိုအပ်ပါသည်။", notice: "စိုးရိမ်သည့်အချက်ကို အတိုချုံး ရေးပါ။ ဤစာကို Workers AI သို့ မပို့ပါ။" },
  },
  ui: {
...
export const reviewedUserMessages = {
  ja: withAssessmentOptions("ja", withDailyLifeNeed(withPublicCopy(jaMessagesWithoutDailyLife, {
    crisis: "行政・支援者向けの確認画面",
    principleBody: "公開データから、地域で確認する意味のある場所へ。",
    sectionLocalAction: "地域での行動",
    openDataLabel: "公開データ",
  }), "日々の生活")),
  en: withAssessmentOptions("en", withDailyLifeNeed(withPublicCopy(enMessagesWithoutDailyLife, {
  ...
  my: withAssessmentOptions("my", withDailyLifeNeed(withPublicCopy(myMessagesWithoutDailyLife, {
