...
const jaMessages = {
  metadata: { label: "Japanese", nativeLabel: "日本語", updatedAt: "2026-08-22", internalReview: { status: "reviewed", reviewedAt: "2026-08-22", reviewedBy: "StayBridge team" }, expertReview: { status: "pending" } },
  ui: {
...
const enMessages = {
  metadata: { label: "English", nativeLabel: "English", updatedAt: "2026-08-22", internalReview: { status: "reviewed", reviewedAt: "2026-08-22", reviewedBy: "StayBridge team" }, expertReview: { status: "pending" } },
  ui: {
...
const myMessages = {
  metadata: { label: "Burmese", nativeLabel: "မြန်မာ", updatedAt: "2026-08-22", internalReview: { status: "reviewed", reviewedAt: "2026-08-22", reviewedBy: "StayBridge team" }, expertReview: { status: "pending" } },
  ui: {
...
export function assertValidUserMessages(value: unknown): asserts value is UserMessagesByLocale {
  ...
  for (const locale of supportedUserLocales) {
    ...
    for (const reviewKey of ["internalReview", "expertReview"] as const) {
      ...
      if (!review || !["pending", "reviewed"].includes(review.status)) throw new Error(`Invalid review status at ${locale}.metadata.${reviewKey}`);
