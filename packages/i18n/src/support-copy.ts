import type { SupportSourceId } from "@staybridge/data";
...
export const supportUiCopy = {
  ja: {
    infoTitle: "関連する公式情報",
    infoNote: "選んだ悩みに関連する、答えがそのページに書いてある公式サイトです。",
    talkTitle: "個別に相談したいとき",
    talkNote: "ご自身の状況に応じた確認が必要なときは、窓口へお問い合わせください。",
    emptyNote: "悩みを選ぶと、関連する公式ページが表示されます。",
    infoLabel: "公式情報",
    handoffLabel: "公式相談",
  },
  en: {
    infoTitle: "Official information for your situation",
    infoNote: "Official pages where the answer to your selected concern is written.",
    talkTitle: "When you want to talk to someone",
    talkNote: "If your situation needs an individual check, contact the desk.",
    emptyNote: "Select your concerns and related official pages will appear here.",
    infoLabel: "OFFICIAL INFORMATION",
    handoffLabel: "OFFICIAL SUPPORT",
  },
  my: {
    infoTitle: "သင့်အခြေအနေနှင့် သက်ဆိုင်သော တရားဝင်အချက်အလက်",
    infoNote: "သင်ရွေးချယ်ထားသော စိုးရိမ်ချက်အတွက် အဖြေကို ထိုစာမျက်နှာတွင် ရေးသားထားသည့် တရားဝင်စာမျက်နှာများ ဖြစ်သည်။",
    talkTitle: "လူတစ်ဦးနှင့် တိုင်ပင်လိုသောအခါ",
    talkNote: "သင့်အခြေအနေကို တစ်ဦးချင်း အတည်ပြုရန် လိုအပ်လျှင် ဌာနသို့ ဆက်သွယ်ပါ။",
    emptyNote: "စိုးရိမ်ချက်များကို ရွေးချယ်ပါ။ သက်ဆိုင်သော တရားဝင်စာမျက်နှာများ ပေါ်လာပါမည်။",
    infoLabel: "တရားဝင်အချက်အလက်",
    handoffLabel: "တရားဝင်အကူအညီ",
  },
} as const satisfies Record<SupportLocale, SupportUiCopy>;
...
export function getLocalizedSupportText(
  sourceId: string,
  field: keyof SupportCopy,
  locale: SupportLocale,
): string | undefined {
  const copy = supportCopy[sourceId as SupportSourceId];
  return copy?.[field][locale].trim() || undefined;
}
