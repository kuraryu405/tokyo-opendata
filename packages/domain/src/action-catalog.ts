...
export const actionCatalog = {
  ...
  CHECK_CHILD_EDUCATION: {
    ...
    sourceIds: ["KITA_ELEMENTARY_SCHOOLS_OPEN_DATA"],
    humanReviewRequired: true,
    riskLevel: "high",
  ...
  CHECK_CHILD_EDUCATION_GUIDANCE: {
    id: "CHECK_CHILD_EDUCATION_GUIDANCE",
    purpose: "Direct a person to official guidance about elementary and junior high school enrollment without deciding eligibility.",
    category: "education",
    timing: "this_week",
    fallback: {
      title: "Check official guidance on school enrollment",
      description: "Confirm where to ask about enrollment procedures and support for your child at the municipality or board of education.",
      cta: "View official guidance",
      notice: "StayBridge does not decide whether your child may enroll. Confirm eligibility, catchment, vacancy, and language support with the municipality or school.",
    },
    sourceIds: ["TOKYO_SCHOOL_ENROLL_EN", "TOKYO_SCHOOL_ATTENDANCE_BOE", "MEXT_SCHOOL", "TIPS_SCHOOL"],
    humanReviewRequired: true,
    riskLevel: "high",
    destination: { screen: "help" },
    review: highRiskReview,
  ...
  FIND_NEARBY_SCHOOLS: {
    id: "FIND_NEARBY_SCHOOLS",
    purpose: "Show a municipality-sourced list of nearby schools without guaranteeing admission or services.",
    category: "education",
    timing: "next_30_days",
    fallback: {
      title: "Find nearby schools",
      description: "View elementary schools published as open data for your municipality.",
      cta: "View nearby schools",
      notice: "A school listing does not confirm enrolment, catchment, vacancy, Japanese language support, or acceptance. Ask the municipality or school.",
    },
    sourceIds: ["KITA_ELEMENTARY_SCHOOLS_OPEN_DATA"],
    humanReviewRequired: true,
    riskLevel: "high",
  ...
  CHECK_MEDICAL_OPTIONS: {
    ...
    sourceIds: ["KITA_MEDICAL_INSTITUTIONS_OPEN_DATA"],
  ...
  CHECK_CHILD_LOCAL_SUPPORT: {
    ...
    sourceIds: ["KITA_CHILDCARE_FACILITIES_OPEN_DATA", "KITA_PUBLIC_FACILITIES_OPEN_DATA"],
    humanReviewRequired: false,
    riskLevel: "standard",
